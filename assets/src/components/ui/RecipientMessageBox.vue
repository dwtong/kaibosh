<template>
  <transition name="fade">
    <Message v-if="status === 'pending'" title="Pending" type="is-info" has-icon aria-close-label="Close message">
      <p>
    ...
    <Message v-if="status === 'archived'" title="Archived" type="is-warning" has-icon aria-close-label="Close message">
