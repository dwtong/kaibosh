...
import RecipientsListFilter from "@/components/RecipientsListFilter.vue";
...
describe("RecipientsListFilter.vue", () => {
  let actions;
  let store;
  let stubs;
  ...
  describe("status filter", () => {
    it("renders all status filters", () => {
      const wrapper = shallowMount(RecipientsListFilter, { store, localVue });
    ...
    it("renders active status label", () => {
      const wrapper = mount(RecipientsListFilter, { store, localVue, stubs });
